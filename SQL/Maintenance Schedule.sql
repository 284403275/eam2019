...
SELECT
    ...
    op.ARBPL AS "Operational Work Center",
...
WHERE "Planned Date" BETWEEN '2018-10-01' AND '2018-10-21'
AND "Order Type" IN ('8F03','8F02','8F01')
--AND "Work Center" IN ('TGM')
AND "Work Order" = '000800293210'
--WHERE "Work Order" = '000800168202'
--AND "Maintenance Plan" = '100000000043'
;
SELECT
    ...
    ,CRHD.ARBPL AS "opp_work_center"
    ,AFVC.ANZZL AS "capacity"
...
AND AUFK.LOEKZ != 'X'
AND (AFKO.GSTRP BETWEEN '20190312' AND '20190312' OR AFKO.GETRI = '20190311')
...
--Basic start date
--AND AFKO.GSTRP BETWEEN '20190312' AND '20190312'
